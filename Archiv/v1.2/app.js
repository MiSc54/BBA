...
function DevCredit() {
    return (React.createElement("p", { className: "ff-mono", style: { textAlign: "center", color: "var(--text-faint)", fontSize: 11, marginTop: 40, marginBottom: 8 } }, "Developed by Michael Schulze"));
}
/* =========================================================================
...
function Dashboard({ logs, plans, allExercises, onGoToPlans, bodyLog, profileDetails, dashboardConfig, onSetRange, currentWeightKg }) {
    ...
    return (React.createElement("div", null,
        ...
        (dashboardConfig?.showWeight || (dashboardConfig?.showEnergy ?? true) || dashboardConfig?.showMeasurements) && (React.createElement("div", { style: { marginTop: 20 } },
            React.createElement("div", { style: { display: "flex", gap: 8, flexWrap: "wrap" } }, RANGE_OPTIONS.map((r) => (React.createElement("button", { key: r.id, className: `ff-tagbtn ${range === r.id ? "selected" : ""}`, onClick: () => onSetRange?.(r.id) }, r.label)))),
            React.createElement("p", { className: "ff-tag-note", style: { marginTop: 8 } },
                "Zeitraum \"",
                ...
                " von ",
                sortedBody.length,
                " K\u00F6rperverlaufs-Eintr\u00E4gen im Diagramm"))),
...
function ExercisesView({ allExercises, allEquipment, ownedEquipment, logs, onAddCustom }) {
    ...
    }, [allExercises, search, muscleFilter, categoryFilter, onlyAvailable, ownedSet, equipmentCategoryById]);
    return (React.createElement("div", null,
        React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "flex-end", flexWrap: "wrap", gap: 16 } },
            React.createElement("div", null,
...
/* =========================================================================
   PLANS LIST VIEW
   ========================================================================= */
function PlansView({ plans, allExercises, allEquipment, ownedEquipment, settings, currentWeightKg, onCreate, onUpdate, onDelete, onClone, onStart }) {
    ...
    return (React.createElement("div", { className: "ff-root" },
        ...
        React.createElement("div", { className: "ff-main" },
            ...
            activeWorkout ? (React.createElement(ActiveWorkoutView, { workout: activeWorkout, allExercises: allExercises, onFinish: handleFinishWorkout, onCancel: () => setActiveWorkout(null) })) : (React.createElement(React.Fragment, null,
                ...
                tab === "plaene" && (React.createElement(PlansView, { plans: plans, allExercises: allExercises, allEquipment: allEquipment, ownedEquipment: equipment, settings: settings, currentWeightKg: currentWeightKg, onCreate: handleCreatePlan, onUpdate: handleUpdatePlan, onDelete: handleDeletePlan, onClone: handleClonePlan, onStart: handleStartWorkout })),
