...
async function collectBackup(profiles) {
    ...
    for (const p of profiles) {
        ...
        profileData[p.id] = { plans, logs, settings };
    }
    return {
        version: 1,
...
function GlobalStyles() {
    return (React.createElement("style", null, `
      ...
      .ff-flash-overlay {
        position: fixed; inset: 0; background: var(--accent); pointer-events: none;
        z-index: 300; animation: restFlash 0.9s ease-out;
      }
    `));
}
...
function PlanEditor({ plan, allExercises, allEquipment, ownedEquipment, settings, onSave, onCancel }) {
...
/* =========================================================================
   PLANS LIST VIEW
   ========================================================================= */
function PlansView({ plans, allExercises, allEquipment, ownedEquipment, settings, onCreate, onUpdate, onDelete, onStart }) {
    const [editing, setEditing] = useState(null); // null | plan | "new"
    if (editing) {
        return (React.createElement(PlanEditor, { plan: editing === "new" ? null : editing, allExercises: allExercises, allEquipment: allEquipment, ownedEquipment: ownedEquipment, settings: settings, onCancel: () => setEditing(null), onSave: (plan) => {
...
function ActiveWorkoutView({ workout, allExercises, onFinish, onCancel }) {
    ...
    return (React.createElement("div", { style: { paddingBottom: rest ? 88 : 0 } },
        flash && React.createElement("div", { className: "ff-flash-overlay" }),
        ...
        rest && (React.createElement("div", { className: "ff-rest-bar" },
...
function SettingsView({ settings, onSaveSettings, profiles, activeProfileId, onCreateProfile, onRenameProfile, onDeleteProfile, onSwitchProfile, onExportBackup, onImportBackup, }) {
...
export default function App() {
    ...
    return (React.createElement("div", { className: "ff-root" },
        ...
        React.createElement("div", { className: "ff-main" }, activeWorkout ? (React.createElement(ActiveWorkoutView, { workout: activeWorkout, allExercises: allExercises, onFinish: handleFinishWorkout, onCancel: () => setActiveWorkout(null) })) : (React.createElement(React.Fragment, null,
            ...
            tab === "plaene" && (React.createElement(PlansView, { plans: plans, allExercises: allExercises, allEquipment: allEquipment, ownedEquipment: equipment, settings: settings, onCreate: handleCreatePlan, onUpdate: handleUpdatePlan, onDelete: handleDeletePlan, onStart: handleStartWorkout })),
